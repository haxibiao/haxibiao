...
import { GQL, graphql, compose, useMutation } from '@src/apollo';
import { useNavigationParam } from '@src/router';
...
const BindAlipay = props => {
    const { me } = userStore;
    // const real_name = useRef(useNavigationParam('real_name') || '');
    // const pay_account = useRef(useNavigationParam('pay_account') || '');
    ...
    const code = useRef(useNavigationParam('code') || '');
