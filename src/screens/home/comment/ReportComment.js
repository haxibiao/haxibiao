...
import { PageContainer, TouchFeedback, HxfTextInput } from '@src/components';
import { graphql, compose, GQL } from '@src/apollo';
...
const styles = StyleSheet.create({
    ...
    saveText: { fontSize: PxDp(15), textAlign: 'center', color: Theme.secondaryColor },
    errorTypes: {
