...
import { PageContainer, Avatar } from '~/components';
                ...
                <View style={styles.container}>
                    ...
                    <View style={styles.body}>
                        ...
                        <Text style={styles.textStyle}>
                            2.在哈希表账户注销期间，如果您的哈希表账户涉及争议纠纷，包括但不限于投诉、举报、国家有权机关调查等，哈希表有权自行终止哈希表评账户的注销而无需另行得到您的同意。
                        </Text>

                        <Text style={styles.textStyle}>
                            3.账户一旦被注销将不可恢复，请您仔细检查智慧点、余额等，您将无法再使用此账户，也将无法找回您哈希表上的个人资料、历史信息、智慧点和余额等（即使您使用相同的手机号码再次注册并使用哈希表）。
                        </Text>

                        <Text style={styles.textStyle}>
                            4.注销本哈希表账户并不代表本哈希表账户注销前的账户行为和相关责任得到豁免或减轻。
                        </Text>
                    </View>
                </View>
            </ScrollView>
