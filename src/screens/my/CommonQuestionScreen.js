            ...
            return (
                <View style={styles.issueItem} key={index}>
                    <View style={styles.question}>
                        <Image style={styles.avatar} source={require('@app/assets/images/xiaodamei_man.png')} />
                    ...
                    <View style={styles.answer}>
                        ...
                        <Image style={styles.avatar} source={require('@app/assets/images/xiaodamei_women.png')} />
                    </View>
                </View>
            );
        });
