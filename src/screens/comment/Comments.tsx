...
import { ItemSeparator, KeyboardSpacer, ListFooter, StatusView } from '~components';
...
const Comments = observer((props: Props) => {
	...
	const isQuestioner = useMemo(() => media.type === 'issue' && media.user.id === userStore.me.id, [media, userStore]);
