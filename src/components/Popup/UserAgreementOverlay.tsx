...
import { appStore, Keys, Storage } from '~/store';
import Row from '../Basic/Row';

import { Overlay } from 'teaset';

import UserAgreementView from '~/screens/settings/UserAgreementView';
import PrivacyPolicyView from '~/screens/settings/PrivacyPolicyView';
